...
//            die;
        ...
        if (isset($_POST['btnsimpan_edit'])) {
            //echo "BTNSIMPAN hasil EDIT HASIL HARMONIS ASLIII"; die;
            //            echo $pemda;die;
...
//            echo "btnsimpan_edit"; die;
            ...
            $id_perancang 	 = htmlentities(strip_tags($this->input->post('id_perancang')));
            $nama_perancang	 = htmlentities(strip_tags($this->input->post('nama_perancang')));

//            echo $id_perancang."<br>";
//            echo $nama_perancang."<br>";
//            die;
            ...
            /*Dokumen Hasil Harmonisasi*/ $lamp_surat_undangan_lama = $data_lama_hasil_harmonis->lamp_surat_undangan;
            /*Dokumen Berita Acara*/ $lamp_berita_acara_lama = $data_lama_hasil_harmonis->lamp_berita_acara;
            /*Dokumen Surat Hasil*/ $lamp_surat_hasil_lama = $data_lama_hasil_harmonis->lamp_surat_hasil;
            ...
            if ( ! $this->upload->do_upload('lamp_surat_undangan'))
            {
                $simpan = 'n';
                $pesan  = htmlentities(strip_tags($this->upload->display_errors('<p>', '</p>')));
                $lamp_surat_undangan_baru = $lamp_surat_undangan_lama;
            } else {
                $gbr = $this->upload->data();
            ...
            if ( ! $this->upload->do_upload('lamp_berita_acara'))
            {
                $simpan = 'n';
                $pesan  = htmlentities(strip_tags($this->upload->display_errors('<p>', '</p>')));
                $lamp_berita_acara_baru = $lamp_berita_acara_lama;
            } else {
                $gbr = $this->upload->data();
                /*keterangan : $lokasi = 'file/bahan_berita';*/
                $filename = "$lokasi/".$gbr['file_name'];
            ...
            if ( ! $this->upload->do_upload('lamp_surat_hasil'))
            {
                $simpan = 'n';
                $pesan  = htmlentities(strip_tags($this->upload->display_errors('<p>', '</p>')));
                $lamp_surat_hasil_baru = $lamp_surat_hasil_lama;
            } else {
                $gbr = $this->upload->data();
                /*keterangan : $lokasi = 'file/bahan_berita';*/
                $filename = "$lokasi/".$gbr['file_name'];
            ...
            if($simpan=='y'){
                ...
                /*Dokumen Hasil Harmonisasi || Dokumen Berita Acara || Dokumen Surat Hasil*/
