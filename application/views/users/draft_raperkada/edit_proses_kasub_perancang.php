                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <select
                                            <?php if($edit_draft->row()->status=="sedang_diproses") { ?> readonly="readonly" <?php } ?>
                                            class="form-control" id="status_dokumen" name="status_dokumen" selected=   required>
...
<!--                                        <option value="menunggu_koreksi" --><?php //if ($edit_draft->row()->status=='menunggu_koreksi') { echo "selected" ;}?><!-- >Menunggu Koreksi</option>-->
                            ...
                            <div class="form-group" style="background-color: ">
                                <label class="col-lg-11" style="background-color:">Naskah Akademik / Penjelasan /  Keterangan</label>
                                <br>
                                <div class="col-lg-12 hidden">
                            ...
                            <div class="form-group" style="background-color: ">
                                ...
                                <br>
                                <div class="col-lg-12 hidden">
                                    <input type="file" value="" name="rancangan_perkada"
                                           id="rancangan_perkada" class="form-control" >
                                </div>
                            </div>
                            ...
                            <div class="">
                                <li class="col-lg-12" style="display: flex ; background-color:  "
                                    ...
                                    <div class="form-group col-lg-12 m-b-10" style="justify-content: space-between; overflow: auto">
                                        <a class="" style="text-decoration: none; overflow: hidden"
                                           href="<?php echo base_url($edit_draft->row()->rancangan_perkada);?>"
                                           target="_blank">
                                            <!--                                                <i class="fa fa-check-square" style=" "></i>-->
