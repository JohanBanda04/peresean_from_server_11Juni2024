                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control default-select2" id="stt"
                                    onchange="window.location.href='harmonisasi/v2/pemprov_ntb/id/'+this.value;">
                                ...
                                <option value="draft_sedang_dibuat" <?php if ('draft_sedang_dibuat' == $link5) {
                                    echo "selected";
                                } ?> >Draft sedang dibuat
                                </option>
                                <option value="menunggu_koreksi" <?php if ('menunggu_koreksi' == $link5) { ?> selected <?php } ?> >
                                    Menunggu koreksi
                                </option>
