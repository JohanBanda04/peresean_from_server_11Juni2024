...
?>
    ...
    <div class="modal fade" id="detail_hasil_harmonisasi<?php echo hashids_encrypt($baris->id_berita); ?>">

        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #225fd5">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color: white">Detail Hasil Harmonisasi</h4>
                </div>
                        ...
                        <div class="form-group col-lg-12" style="justify-items: end; background-color: ">
                            <div class="row m-l-1" style=" overflow: hidden;  ">
                                ...
                                if($baris->lamp_surat_undangan!=""){
                                    ...
                                    <?php
                                } else if($baris->lamp_surat_undangan==""){
                                    ?>
                                    <label for="label" class="label" style="background-color: red">Belum ada hasil harmonisasi</label>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="form-group col-lg-12" style="justify-items: end; background-color: ">
                            <div class="row m-l-1" style=" overflow: hidden;  ">
                                ...
                                if($baris->lamp_berita_acara!=""){
                                    ...
                                    <?php
                                } else if($baris->lamp_berita_acara==""){
                                    ?>
                                    <label for="label" class="label" style="background-color: red">Belum ada dokumen berita acara</label>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="form-group col-lg-12" style="justify-items: end; background-color: ">
                            <div class="row m-l-1" style=" overflow: hidden;  ">
                                ...
                                if($baris->lamp_surat_hasil!=""){
                                    ...
                                    <?php
                                } else if($baris->lamp_surat_hasil==""){
                                    ?>
                                    <label for="label" class="label" style="background-color: red">Belum ada dokumen surat hasil</label>
                                    <?php
                                }
                                ?>
