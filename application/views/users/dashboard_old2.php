        ...
        <div class="panel panel-inverse">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div <?php if ($_SESSION['nama_zona'] == 'superadmin') { ?> class="col-md-4" <?php }
                    else if ($_SESSION['nama_zona'] == 'kasub_perancang') { ?> class="col-md-4" <?php }
                    else { ?> class="hidden col-md-4" <?php } ?>>
